...
public class MvInfoDAO {
   ...
   public int insertMv(MvInfoVO vo) throws SQLException {
      ...
      try {
         ...
         ps.setString(10, vo.getMvTitleEn());
         ps.setString(11, vo.getMvCode());
      ...
      try {
         ...
         while(rs.next()) {
            ...
            MvInfoVO vo = new MvInfoVO(mvNo, mvTitle, genre, director, 
                  actors, story, thumbnail, nation, makeYear,
                  boxOffice, regdate, mvCode, mvTitleEn);
            list.add(vo);
         }
   ...
   public List<MvInfoVO> selectAllMv(String option,String keyword) throws SQLException {
      ...
      try {
         ...
         while(rs.next()) {
            ...
            MvInfoVO vo = new MvInfoVO(mvNo, mvTitle, genre, director, actors, story, thumbnail, nation, makeYear, boxOffice, regdate, mvCode, mvTitleEn);
