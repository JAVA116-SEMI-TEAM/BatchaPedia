...
<div class="faq">
	...
	<!-- 탭 메뉴 -->
	<form id="faqSelectForm" name="faqSelectForm">
	<div class="tabMenu">
		<ul class="nav nav-tabs">
			<li class="nav-item itemli" value="all"><a class="nav-link active"
				style="color: gray;" data-toggle="tab" href="#all">전체</a></li>
			<li class="nav-item itemli" value="account"><a class="nav-link"
				style="color: gray;" data-toggle="tab" href="#accountMg">계정관리</a></li>
			<li class="nav-item itemli" value="login"><a class="nav-link"
				style="color: gray;" data-toggle="tab" href="#personalInfo">개인정보</a></li>
			<li class="nav-item itemli" value="use"><a class="nav-link"
	...
	<div class="tab-content">
		...
		<div class="tab-pane show fade active" id="all">
			<div class="faqList" id="faqAccor">
				...
				%>
				<button class="accordion btn-secondary" id="<%=faqVo.getOpt()%>"
	...
	<!-- 	<!-- 계정관리 -->
		<div class="tab-pane fade" id="accountMg" name="account">
			<div class="faqList" id="faqAccor">
				<%
					for (int i = 0; i < 5; i++) {
					FaqVO faqVo = faqList.get(i);
				%>
				<button class="accordion btn-secondary" id="faqTitle">
					<%=faqVo.getTitle()%></button>
				<div class="panel">
					<pre><%=faqVo.getContent()%></pre>
				</div>
