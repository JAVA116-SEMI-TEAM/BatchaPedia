...
%>
	...
	<div class="contant-warp">
		<form class="form-compact" name="ntcfmt"
			action="<%=request.getContextPath()%>/notice/noticeEditOK.do"
			method="post">
			<div class="nt-titleWarp">
				<div class="row nt-title">
					<h2 class="text-center col-12 mb-0">공지사항 수정</h2>
				</div>
			...
			<div class="divForm">
				...
				<input type="hidden" name="noticeNo" value="<%=ntVo.getNoticeNo()%>">

				<div class="row align-items-center">
					<div class="col-12">
						<div class="input-group">
							<input type="text" id="ntTitle" name="ntTitle" value="<%=ntVo.getTitle() %>"
